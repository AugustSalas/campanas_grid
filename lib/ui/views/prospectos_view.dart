...
import 'package:campanas_grid/ui/shared/components/selects_table_info.dart';
...
class _ProspectosViewState extends State<ProspectosView> {
  ...
  late ProspectosProvider prospectosProvider;
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      ...
      Provider.of<ProspectosProvider>(context, listen: false)
          .getActiveCampaigns();
      Provider.of<ProspectosProvider>(context, listen: false).getProspectos();
    });
  }
